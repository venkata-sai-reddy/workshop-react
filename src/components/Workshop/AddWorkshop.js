                    ...
                    <Grid item xs={12}>
                        <FormControl fullWidth>
                            <TextField
                                ...
                                automationId='create_workshop_title_field'
                    ...
                    <Grid item xs={12}>
                        <FormControl fullWidth>
                            <TextField
                                ...
                                automationId='create_workshop_description_field'
                                label="Description"
                                multiline
                                rows={6}
                            ...
                            <Autocomplete
                                ...
                                renderInput={(params) => (
                                    <TextField
                                        ...
                                        automationId='create_workshop_skills_field'
                                        {...params}
                                        label="Skills *"
                            ...
                            <Autocomplete
                                ...
                                renderInput={(params) => (
                                    <TextField {...params} id='create_workshop_venue_field'
                                        automationId='create_workshop_venue_field' label="Venue" name="venue" fullWidth />
                                )}
                            />
                        </FormControl>
                    </Grid>
                    ...
                    <Grid item xxs={12} xs={6} sm={2} md={4}>
                        <FormControl fullWidth>
                            <TextField
                                ...
                                automationId='create_workshop_capacity_field'
                                label="Capacity"
                                type="number"
                                {...register('capacity')}
                    ...
                    <Grid item xxs={12} xs={6} sm={4} md={4}>
                        <FormControl fullWidth>
                            <TextField
                                ...
                                automationId='create_workshop_date_field'
                                label="Workshop Date *"
                                type="date"
                                InputLabelProps={{
                                    shrink: true,
                    ...
                    <Grid item xxs={12} xs={6} sm={4} md={4}>
                        <FormControl fullWidth>
                            <TextField
                                ...
                                automationId='create_workshop_start_time_field'
                                label="Start Time *"
                                type="time"
                                InputLabelProps={{
                                    shrink: true,
                    ...
                    <Grid item xxs={12} xs={6} sm={4} md={4}>
                        <FormControl fullWidth>
                            <TextField
                                ...
                                automationId='create_workshop_end_time_field'
                                label="End Time *"
                                type="time"
                                InputLabelProps={{
                                    shrink: true,
